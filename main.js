function StartClassification()
{
    ...
    classifier = ml5.soundClassifier("https://teachablemachine.withgoogle.com/models/3DjKeNJGB/model.json", ModelReady)
}
...
else if (results[0].label == "marble")
{
